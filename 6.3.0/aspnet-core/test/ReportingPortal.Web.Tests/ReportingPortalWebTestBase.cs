...
{
    public abstract class ReportingPortalWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ReportingPortalWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ReportingPortalWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ReportingPortalDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ReportingPortalDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ReportingPortalDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ReportingPortalDbContext, Task<T>> func)
        {
            T result;
